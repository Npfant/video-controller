...
#
# Script generated by Vivado on Thu Apr 24 21:53:26 CDT 2025
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nfant/vc-standalone/vc_standalone/vc_standalone.cache/compile_simlib/xcelium"
  fi
